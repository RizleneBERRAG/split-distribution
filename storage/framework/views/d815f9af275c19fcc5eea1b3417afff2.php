<?php $__env->startSection('title', 'Climatisation professionnelle | Split Distribution'); ?>
...
<?php $__env->startPush('styles'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/css/pages/climatisation.css'); ?>
<?php $__env->stopPush(); ?>

<?php $__env->startSection('body-class', 'page-climatisation'); ?>
            ...
            <div class="clim-hero__grid">
                <div class="clim-hero__content">
                    ...
                    <div class="clim-hero__actions">
                        <a href="<?php echo e(route('contact')); ?>" class="button button--primary">
    ...
    <section class="clim-architectures" id="architectures">
        <div class="container clim-architectures__grid">
            <header class="clim-architectures__header">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="clim-outline-link">
    ...
    <section class="clim-cta">
        <div class="container clim-cta__grid">
            ...
            <div class="clim-cta__action">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="clim-cta__button">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/split-distribution/split-distribution/resources/views/pages/solutions/climatisation.blade.php ENDPATH**/ ?>