<?php $__env->startSection('title', 'Pompes à chaleur professionnelles | Split Distribution'); ?>
...
<?php $__env->startPush('styles'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/css/pages/pompes-a-chaleur.css'); ?>
<?php $__env->stopPush(); ?>

<?php $__env->startSection('body-class', 'page-pac'); ?>
        ...
        <div class="container">
            ...
            <div class="pac-hero__stage">
                <div class="pac-hero__media">
                    <img
                        src="<?php echo e(asset('images/solutions/pompes-a-chaleur/hero-pac.webp')); ?>"
                ...
                <div class="pac-hero__heading">
                    ...
                    <div class="pac-hero__intro">
                        ...
                        <a href="<?php echo e(route('contact')); ?>" class="pac-button">
    ...
    <section class="pac-guidance">
        <div class="container pac-guidance__inner">
            ...
            <div class="pac-guidance__bottom">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="pac-button pac-button--light">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/split-distribution/split-distribution/resources/views/pages/solutions/pompes-a-chaleur.blade.php ENDPATH**/ ?>