...
<?php $__env->startSection('content'); ?>
    ...
    <section class="home-hero">
        ...
        <div class="home-hero__background">
            <img
                src="<?php echo e(asset('images/home/hero-hvac.webp')); ?>"
    ...
    <section class="home-cee" aria-labelledby="home-cee-title">
        <div class="container home-cee__inner">
            ...
            <a class="home-cee__link" href="<?php echo e(route('contact')); ?>">
    ...
    <section class="home-expertises">
        ...
        <div class="container">
            ...
            <div class="home-expertises__grid">
                ...
                <a
                    href="<?php echo e(route('solutions.climatisation')); ?>"
                    class="
                        expertise-card
                ...
                >
                    ...
                    <img
                        src="<?php echo e(asset('images/home/climatisation.webp')); ?>"
                ...
                <a
                    href="<?php echo e(route('solutions.pompes-a-chaleur')); ?>"
                    class="expertise-card"
                >

                    <img
                        src="<?php echo e(asset('images/home/pac.webp')); ?>"
                ...
                <a
                    href="<?php echo e(route('solutions.ventilation')); ?>"
                    class="expertise-card"
                >

                    <img
                        src="<?php echo e(asset('images/home/ventilation.webp')); ?>"
                ...
                <a
                    href="<?php echo e(route('solutions.tertiaire')); ?>"
                    class="
                        expertise-card
                        expertise-card--wide
                    "
                >
                    ...
                    <img
                        src="<?php echo e(asset('images/home/tertiaire.webp')); ?>"
                ...
                <a
                    href="<?php echo e(route('solutions.energies-renouvelables')); ?>"
                    class="
                        expertise-card
                        expertise-card--wide
                    "
                >
                    ...
                    <img
                        src="<?php echo e(asset('images/home/energies.webp')); ?>"
                ...
                <a
                    href="<?php echo e(route('solutions.accessoires')); ?>"
                    class="
                        expertise-card
                        expertise-card--wide
                    "
                ...
                <div class="expertise-chameleon">
                    ...
                    <div class="expertise-chameleon__visual">
                        ...
                        <img
                            src="<?php echo e(asset('images/brand/chameleon-signature.webp')); ?>"
                            alt=""
                            aria-hidden="true"
                            width="1536"
                            height="1024"
    ...
    <div class="brands-marquee">
        ...
        <div class="brands-marquee__track">
            ...
            <div class="brand-logo">
                <img
                    src="<?php echo e(asset('images/brands/atlantic.png')); ?>"
                    alt="Atlantic"
                    loading="lazy"
                >
            </div>
            ...
            <div class="brand-logo">
                <img
                    src="<?php echo e(asset('images/brands/general.png')); ?>"
                    alt="General Fujitsu"
                    loading="lazy"
                >
            </div>
            ...
            <div class="brand-logo">
                <img
                    src="<?php echo e(asset('images/brands/toshiba-carrier.png')); ?>"
                    alt="Toshiba Carrier"
                    loading="lazy"
                >
            </div>
            ...
            <div class="brand-logo">
                <img
                    src="<?php echo e(asset('images/brands/haier.png')); ?>"
            ...
            <div class="brand-logo">
                <img
                    src="<?php echo e(asset('images/brands/lennox.png')); ?>"
                    alt="Lennox"
                    loading="lazy"
                >
            </div>
            ...
            <div class="brand-logo">
                <img
                    src="<?php echo e(asset('images/brands/enphase.png')); ?>"
                    alt="Enphase"
                    loading="lazy"
                >
            </div>
            ...
            <div class="brand-logo">
                <img
                    src="<?php echo e(asset('images/brands/apsystems.png')); ?>"
                    alt="APsystems"
                    loading="lazy"
                >
            </div>
            ...
            <div class="brand-logo">
                <img
                    src="<?php echo e(asset('images/brands/trina-solar.png')); ?>"
                    alt="Trina Solar"
                    loading="lazy"
                >
            </div>
            ...
            <div class="brand-logo">
                <img
                    src="<?php echo e(asset('images/brands/qcells.png')); ?>"
                    alt="Qcells"
                    loading="lazy"
                >
            </div>
            ...
            <div class="brand-logo">
                <img
                    src="<?php echo e(asset('images/brands/meyer-burger.png')); ?>"
                    alt="Meyer Burger"
                    loading="lazy"
                >
            </div>
            ...
            <div class="brand-logo">
                <img
                    src="<?php echo e(asset('images/brands/sabiana.png')); ?>"
                    alt="Sabiana"
                    loading="lazy"
                >
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/split-distribution/split-distribution/resources/views/pages/home.blade.php ENDPATH**/ ?>