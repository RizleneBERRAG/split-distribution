<?php $__env->startSection('title', 'Énergies renouvelables & photovoltaïque | Split Distribution'); ?>
...
<?php $__env->startPush('styles'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/css/pages/energies-renouvelables.css'); ?>
<?php $__env->stopPush(); ?>

<?php $__env->startSection('body-class', 'page-energies'); ?>
        ...
        <div class="container">
            ...
            <div class="energy-hero__heading">
                ...
                <div class="energy-hero__intro">
                    ...
                    <div>
                        <a href="<?php echo e(route('contact')); ?>">Étudier mon projet <span aria-hidden="true">↗</span></a>
    ...
    <section class="energy-cta">
        <div class="container energy-cta__grid">
            ...
            <div>
                ...
                <a href="<?php echo e(route('contact')); ?>">Échanger avec l’équipe <span aria-hidden="true">↗</span></a>
            </div>
        </div>
    </section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/split-distribution/split-distribution/resources/views/pages/solutions/energies-renouvelables.blade.php ENDPATH**/ ?>