<?php $__env->startSection('title', 'Services | Split Distribution'); ?>
...
<?php $__env->startPush('styles'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/css/pages/services.css'); ?>
<?php $__env->stopPush(); ?>

<?php $__env->startSection('body-class', 'page-services'); ?>
        ...
        <div class="container">
            ...
            <div class="services-hero__heading">
                ...
                <div class="services-hero__summary">
                    ...
                    <div class="services-hero__actions">
                        <a href="<?php echo e(route('contact')); ?>" class="services-button services-button--green">
            ...
            <div class="services-stage">
                <figure class="services-stage__image">
                    <img
                        src="<?php echo e(asset('images/services/order-preparation.webp')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/split-distribution/split-distribution/resources/views/pages/services.blade.php ENDPATH**/ ?>