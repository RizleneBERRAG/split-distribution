<?php $__env->startSection('title', 'Solutions CVC tertiaires | Split Distribution'); ?>
...
<?php $__env->startPush('styles'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/css/pages/tertiaire.css'); ?>
<?php $__env->stopPush(); ?>

<?php $__env->startSection('body-class', 'page-tertiaire'); ?>
            ...
            <div class="tert-hero__grid">
                <div class="tert-hero__content">
                    ...
                    <div class="tert-hero__actions">
                        <a href="<?php echo e(route('contact')); ?>">Parler du bâtiment <span aria-hidden="true">↗</span></a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/split-distribution/split-distribution/resources/views/pages/solutions/tertiaire.blade.php ENDPATH**/ ?>