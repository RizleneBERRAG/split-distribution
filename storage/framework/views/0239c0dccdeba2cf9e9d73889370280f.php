<?php $__env->startSection('title', 'Mentions légales | Split Distribution'); ?>
    ...
    <section class="legal-content">
        <div class="container legal-content__layout">
            <aside class="legal-summary">
                ...
                <a href="<?php echo e(route('contact')); ?>">Contacter Split Distribution <span aria-hidden="true">↗</span></a>
            </aside>
            ...
            <div class="legal-sections">
                ...
                <article>
                    ...
                    <div>
                        ...
                        <p>Les modalités de traitement des demandes et l’exercice de vos droits sont détaillés dans notre <a href="<?php echo e(route('legal.privacy')); ?>">politique de confidentialité</a>.</p>
                    </div>
                </article>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/split-distribution/split-distribution/resources/views/pages/legal/mentions.blade.php ENDPATH**/ ?>