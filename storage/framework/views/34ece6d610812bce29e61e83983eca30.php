<?php $__env->startSection('title', 'Politique de confidentialité | Split Distribution'); ?>
...
<?php $__env->startPush('styles'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/css/pages/legal.css'); ?>
<?php $__env->stopPush(); ?>

<?php $__env->startSection('body-class', 'page-legal'); ?>
    ...
    <section class="legal-content">
        <div class="container legal-content__layout">
            <aside class="legal-summary legal-summary--privacy">
                ...
                <a href="<?php echo e(route('contact')); ?>">Faire une demande <span aria-hidden="true">↗</span></a>
            </aside>
            ...
            <div class="legal-sections">
                <article>
                    ...
                    <div>
                        ...
                        <p>Pour toute question relative à vos données ou pour exercer vos droits, écrivez à <a href="mailto:contact@split-distribution.fr">contact@split-distribution.fr</a> ou utilisez le <a href="<?php echo e(route('contact')); ?>">formulaire de contact</a>.</p>
                    </div>
                </article>
                ...
                <article>
                    ...
                    <div>
                        <h2>Vos droits</h2>
                        <p>Vous pouvez demander l’accès à vos données, leur rectification, leur effacement, la limitation du traitement ou vous opposer à celui-ci lorsque la loi le permet. Vous pouvez exercer ces droits en écrivant à <a href="mailto:contact@split-distribution.fr">contact@split-distribution.fr</a> ou via notre <a href="<?php echo e(route('contact')); ?>">page de contact</a>.</p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/split-distribution/split-distribution/resources/views/pages/legal/privacy.blade.php ENDPATH**/ ?>