<?php $__env->startSection('title', 'L’entreprise | Split Distribution'); ?>
...
<?php $__env->startPush('styles'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/css/pages/entreprise.css'); ?>
<?php $__env->stopPush(); ?>

<?php $__env->startSection('body-class', 'page-entreprise'); ?>
    ...
    <section class="company-hero">
        <div class="company-hero__grid">
            <div class="company-hero__content">
                ...
                <div class="company-hero__copy">
                    ...
                    <div class="company-hero__actions">
                        <a href="<?php echo e(route('contact')); ?>" class="company-button company-button--green">
            ...
            <figure class="company-hero__visual">
                <img
                    src="<?php echo e(asset('images/entreprise/team-work.webp')); ?>"
        ...
        <div class="container">
            ...
            <div class="company-intro__body">
                ...
                <aside class="company-address">
                    ...
                    <a href="<?php echo e(route('contact')); ?>">Nous rencontrer <span aria-hidden="true">↗</span></a>
                </aside>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/split-distribution/split-distribution/resources/views/pages/entreprise.blade.php ENDPATH**/ ?>