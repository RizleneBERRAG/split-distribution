<?php $__env->startSection('title', 'Ventilation professionnelle | Split Distribution'); ?>
...
<?php $__env->startPush('styles'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/css/pages/ventilation.css'); ?>
<?php $__env->stopPush(); ?>

<?php $__env->startSection('body-class', 'page-ventilation'); ?>
            ...
            <div class="vent-hero__grid">
                <div class="vent-hero__content">
                    ...
                    <div class="vent-hero__actions">
                        <a href="<?php echo e(route('contact')); ?>" class="vent-button vent-button--dark">
    ...
    <section class="vent-cta">
        <div class="container vent-cta__grid">
            ...
            <div class="vent-cta__action">
                ...
                <a href="<?php echo e(route('contact')); ?>">Parler à l’équipe <span aria-hidden="true">↗</span></a>
            </div>
        </div>
    </section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/split-distribution/split-distribution/resources/views/pages/solutions/ventilation.blade.php ENDPATH**/ ?>